 ...
 */
// PROGRAMA QUE DETERMINA de 6 NUMEROS CUALES SON PARES E IMPARES USANDO do while
package lab2.pkg2;
...
// se anidan dos ciclos do while para recorrer la matriz
        do {

            do {
// se hace la estructura del  descisiones condicionales con un switch
                switch (j) {
                    case 0:
